        ...
        <motion.div
          className={`absolute top-0 left-0 w-full h-full opacity-50 ${
            currentTheme === 'dark'
              ...
              : 'bg-gradient-to-r from-blue-100/20 via-purple-100/20 to-pink-100/20'
          }`}
          animate={{
            background:
              currentTheme === 'dark'
        ...
        {mounted && (
          <>
            ...
            {Array.from({ length: 3 }).map((_, i) => (
              <motion.div
                key={`diffuse-orb-${i}`}
                className="absolute blur-[100px] opacity-100"
                style={{
                  width: `${400 + i * 200}px`,
                  height: `${400 + i * 200}px`,
                  left: `${20 + i * 30}%`,
        ...
        {loading ? (
          <div className="columns-1 md:columns-2 lg:columns-3 gap-6 space-y-6 max-w-5xl mx-auto">
            {Array.from({ length: 12 }).map((_, index) => (
              ...
              >
                <div
                  className={`backdrop-blur-2xl border rounded-2xl shadow-xl overflow-hidden relative ${
                    currentTheme === 'dark'
          ...
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.5 }}
            className={`text-center py-16 backdrop-blur-2xl border rounded-2xl shadow-xl max-w-lg mx-auto relative ${
              currentTheme === 'dark'
                ? 'bg-gradient-to-br from-white/25 to-white/15 border-white/30'
                : 'bg-gradient-to-br from-white/40 to-white/20 border-white/30'
            }`}
            ...
            <AnimatePresence>
              <div className="columns-1 md:columns-2 lg:columns-3 gap-6 space-y-6 max-w-5xl mx-auto">
                {filteredTracks.map((track, index) => (
                  ...
                  >
                    <div
                      className={`backdrop-blur-2xl border rounded-2xl shadow-xl overflow-hidden transition-all duration-300 relative ${
                        currentTheme === 'dark'
                          ...
                          : 'bg-gradient-to-br from-white/40 to-white/20 border-white/30 hover:shadow-2xl hover:from-white/50 hover:to-white/30 hover:border-white/40'
                      }`}
                      style={{
                        boxShadow:
                          currentTheme === 'dark'
                      ...
                      <Card className="bg-transparent border-0 relative z-10">
                        ...
                        <CardFooter>
                          <Link href={`/tracks/${track.slug}`} className="w-full">
                            <Button
                              className={`w-full border-0 rounded-xl py-3 font-medium transition-all duration-300 ${
                                currentTheme === 'dark'
